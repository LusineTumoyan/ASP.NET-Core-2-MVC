...
namespace DataAccessLayer.DBTools
{
    public class DBAccess
    {
        ...
        public static async Task<T> ExecuteSPWithSingleResult<T>(string procedureName, List<SPParam> parameters) where T : IDataMapper, new()
        {
            T obj = default(T);
            try
            {
        ...
        public static async Task<List<T>> ExecuteSPWithListResult<T>(string procedureName, List<List<SPParam>> parameters) where T : IDataMapper, new()
        {
            List<T> list = null;
            try
            {
        ...
        public static async Task ExecuteSPWithNoResult<T>(string procedureName, List<SPParam> parameters) where T : IDataMapper
        {
            try
            {
                await Task.Run(() =>
